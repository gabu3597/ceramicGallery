      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-slide-in-left">
            <div className="relative">
              <img
                ...
                className="w-full h-96 lg:h-[500px] object-cover rounded-lg shadow-lg hover-scale transition-all duration-500"
              />
              <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-secondary rounded-lg shadow-lg flex items-center justify-center animate-pulse-glow hover-lift">
          ...
          <div className="animate-slide-in-right">
            <div className="mb-6">
              <div className="w-12 h-1 bg-secondary mb-4 animate-shimmer" />
              <ScrollReveal
            ...
            <div className="space-y-6">
              <p className="text-lg leading-relaxed text-foreground animate-fade-in stagger-1">
              ...
              <p className="text-lg leading-relaxed text-muted-foreground animate-fade-in stagger-2">
              ...
              <div className="grid grid-cols-2 gap-6 pt-6 animate-slide-in-up stagger-3">
